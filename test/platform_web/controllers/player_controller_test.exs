defmodule PlatformWeb.PlayerControllerTest do
  ...
  @create_attrs %{password: "some_password", username: "some username"}
  @update_attrs %{display_name: "some updated display_name", password: "some updated password", score: 43, username: "some updated username"}
